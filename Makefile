...
debt:
	...
	@echo
	@echo "  The instrument is the scored Test exercises, NOT the Quiz -- and the"
	@echo "  reason is contamination rather than reach. This ledger said the Quiz"
	@echo "  runs on the Foundation thirteen only, so a standard defined against"
	@echo "  it would be unmeasurable on thirty-four of the forty-seven; every"
	@echo "  one of the forty-seven carries a Quiz, which retires that half. What"
