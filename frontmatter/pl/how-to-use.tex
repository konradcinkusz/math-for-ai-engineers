...
\emph{ramkami}. Prawie każda ramka kończy się pytaniem --- o liczbę, słowo
...
papieru. Zapisz swoją odpowiedź --- na papierze, nie w głowie --- i dopiero
wtedy odsłoń.
...
najbardziej się liczy --- czyli w tych, których nie jesteś pewien.
\end{warning}
...
\begin{enumerate}[leftmargin=1.6em, itemsep=3pt]
  ...
  \item \emph{teraz jeden przykład do wykonania dla ciebie} --- rozwiązujesz
...
mniejszą pomocą --- dlatego zwykle wydaje się łatwa, a nie onieśmielająca. Ten
...
\toprule
\textbf{Efekty kształcenia} & Co będziesz umiał --- wypisane, zanim
...
\textbf{Dalsze wyzwania} & Utrwalenie --- i więcej, niż będziesz chciał. \\
\bottomrule
\end{tabularx}
\end{center}
...
tego, co program ci dał --- i bywa wyraźnie mniejsza niż poczucie
zrozumienia.
...
Następnie zacznij od Programu~1 i czytaj główne części po kolei --- nie są
...
\begin{note}
Metoda Strouda została zweryfikowana do poziomu \textbf{80/80}: co najmniej 80
procent uczniów uzyskiwało co najmniej 80 procent, w badaniach z grupami
kontrolnymi. Istotne jest jednak nie to, że średnia wzrosła, lecz to, że
\emph{rozstęp się zmniejszył} --- metoda podnosi przede wszystkim dół
rozkładu.

\textbf{Tej książki nie przetestowano na ani jednym czytelniku.} Pożycza
metodę i nie ma prawa pożyczyć dowodów. Każde budowanie tej książki wypisuje
to jako zaległość i będzie wypisywać, dopóki ktoś nie przeprowadzi badania.
\end{note}
