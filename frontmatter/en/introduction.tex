...
\textbf{Part~III \dash{} Linear algebra} (P4--P10) is the largest part, because it
is the subject this audience uses daily and understands least.

\textbf{Part~IV \dash{} Discrete structures and argument} (P11--P13) covers
...
\textbf{Part~V \dash{} Calculus and automatic differentiation} (P14--P17) takes the
chain rule all the way to what \code{loss.backward()} does.

\textbf{Part~VI \dash{} Optimisation} (P18--P21) is absent from Stroud's first
volume entirely.

\textbf{Part~VII \dash{} Probability and statistics} (P22--P27) goes past the
...
\textbf{Part~VIII \dash{} Information theory} (P28--P30) is where the loss function
comes from.

\textbf{Part~IX \dash{} Assembling it} (P31--P33) spends the whole book on one
