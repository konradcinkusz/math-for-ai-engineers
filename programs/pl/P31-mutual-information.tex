...
\sumitem{20--21}{\textbf{Standardowa poprawka zawodzi najbardziej tam, gdzie
  jest najbardziej potrzebna}: $\val{p31.bias.ratio10}$ raza obok przy
  $N = 10$, zbiegając do $\val{p31.bias.ratio100}$ przy $N = 100$.}
\sumitem{22--23}{\textbf{Szesnaście kategorii w każdą stronę wymaga
...
\item Liczysz wtykową informację wzajemną $\num{0.05}$ nata między binarną
  ...
  $\val{p31.bias.n50}$ a $\val{p31.bias.n100}$ nata, więc większość
  $\num{0.05}$ mogłaby być estymatorem. Przetasuj etykiety, puść jeszcze raz
  i podaj różnicę.}
