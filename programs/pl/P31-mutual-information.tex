...
\sumitem{3--4}{\textbf{\result{Informacja wzajemna jest dywergencją}}:
...
\sumitem{26--27}{\textbf{\result{Przetwarzanie nie tworzy informacji}}: jeśli
...
\sumitem{35--38}{\textbf{\result{Nic tutaj nie zostało zmierzone na prawdziwym
