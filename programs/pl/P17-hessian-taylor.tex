...
ogranicza.}{czynnik rozstrzygający o wzroście}
\end{fr}
...
\mermaidfig{p17-sharp-is-not-a-fact}{Ta sama funkcja, dwie krzywizny.}{%
  ta sama funkcja, inna krzywizna}
\end{fr}
...
I zauważ, że kłopotliwa reparametryzacja nie jest jednym przypadkiem, który
dałoby się zakazać. Przeskalowanie powyżej użyło jednej współrzędnej i jednej
stałej, a nic w tym rozumowaniu nie zależało od żadnej z nich: każda dodatnia
stała daje następne, a każda współrzędna daje ich rodzinę. Odpowiedzią nie może
więc być reguła wykluczająca jedną niewygodną zamianę zmiennych, bo jest ich
kontinuum i wszystkie są równie prawomocne.
