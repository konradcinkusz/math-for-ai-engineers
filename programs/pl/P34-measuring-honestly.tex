...
\outcome{20--28}{powiedzieć, co niedoskonały sędzia robi ze zmierzoną różnicą
  i co trzeba by o sędzim wiedzieć, by to skorygować}
...
\sumitem{17--18}{\result{Precyzja idzie jak $1/\sqrt{n}$, więc połowienie przedziału
...
\sumitem{24--26}{\result{Dzieli to użyteczną liczbę pozycji przez $(a-b)^{2}$, a
