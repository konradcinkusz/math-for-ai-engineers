...
Tam bity na znak to bity na token razy tokeny na znak i \textbf{jeden z
dwóch czynników należy do tokenizatora}: ten sam model na tym samym tekście
raportuje $\val{p29.bpc.a}$ i $\val{p29.bpc.b}$ bita na znak przy
$\val{p29.tpc.a}$ i $\val{p29.tpc.b}$ tokena na znak.

Tutaj \textbf{oba czynniki należą do modelu}. Cena jest faktem o tym, który
model wywołałeś, a długość faktem o tym, jak on odpowiada, dlatego właśnie
podanie jednej z nich niczego nie załatwia.
