%% P19 --- Metoda gradientu prostego: od SGD do Adama
%%
...
estimate of "how far and in which direction", and each addition fixes a
...
Adam divides by the square root of the second moment --- it is a per-
