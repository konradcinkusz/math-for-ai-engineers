...
Program~\ref{prog:P29} ma dla tego źródła własny najlepszy kod \dash{} cztery
dwucyfrowe słowa \dash{} a cztery dwucyfrowe słowa dają średnio dokładnie
$\val{p30.src.ce}$ przy dowolnym rozkładzie. Kod, którym wysyłasz to źródło,
remisuje więc z najlepszym, jaki dałoby się zbudować: \textbf{względem
