...
\begin{summarybox}
\sumitem{1--3}{\textbf{Entropia krzyżowa to tyle, ile kosztuje kod}:
...
\sumitem{4--6}{\textbf{Ten koszt się dzieli}: $H(p, q) = H(p) + \KL{p}{q}$.
...
\sumitem{7--9}{\textbf{Nadwyżka nigdy nie jest ujemna}, na mocy nierówności
...
\sumitem{11--12}{Entropia krzyżowa ma więc podłogę, a tą podłogą jest
  entropia \emph{celu}. Strata, która przestaje spadać, mogła dojść, a nie
  utknąć, i sama strata nie powie ci która.}
\sumitem{13--16}{\textbf{Nie jest symetryczna.} Na rozkładzie z
...
\sumitem{17--18}{A para, która wychodzi prawie równa \dash{}
  ...
  niczego: wielkość jednego kierunku nie ogranicza drugiego.}
\sumitem{19--21}{\textbf{Cały mechanizm to jeden wyraz.} Tam, gdzie cel ma
  ...
  liczby.}
\sumitem{24--30}{\textbf{W przód pokrywa garby, wstecz szuka garbu},
...
\sumitem{34--38}{\textbf{To nie jest odległość.} Nierówność trójkąta, którą
...
\sumitem{39--42}{\textbf{Usymetrycznienie kosztuje sygnał.} Dywergencja
...
\sumitem{43--45}{\textbf{Trening na stałym zbiorze danych minimalizuje
...
\item Weź $p = (\num{0.5}, \num{0.5})$ oraz $q = (1, 0)$. Policz oba
  ...
  Jensena--Shannona wynosi $\val{p30.js.cap}$ w obu kierunkach, będąc
  symetryczną \dash{} to ograniczenie, osiągnięte, bo oba nie dzielą
  nośnika poza tym, co ma punkt środkowy.}
