...
% ============================================================
\begin{summarybox}
\sumitem{1--4}{Estymator ma \textbf{dwa} sposoby bycia w błędzie.
  \emph{Obciążenie} to odległość średniej oceny od prawdy;
  \emph{wariancja} to odległość ocen od ich własnej średniej.
  Program~\ref{prog:P21} dowiódł pierwszego o gradiencie z paczki i
  powiedział, że to nie wystarcza.}
\sumitem{5--6}{\textbf{$\mathrm{MSE} = \text{obciążenie}^{2} + \Var$},
...
\sumitem{7--9}{Zatem \enquote{nieobciążony} to nie \enquote{najlepszy}, a
  ...
  przepis.}
\sumitem{10--12}{$n-1$ poprawia \textbf{dokładnie jedno obciążenie}:
  ...
  dokładnie.}
\sumitem{13--16}{\textbf{Nie poprawia odchylenia standardowego.} Pierwiastek
...
\sumitem{18--20}{\textbf{Metoda największej wiarogodności} wybiera parametr,
...
\sumitem{21}{Ocena bernoullowska to $k/n = \val{p26.bern.mle}$, wyprowadzona,
...
\sumitem{22--23}{A wariancja gaussowska wychodzi z $n$ w mianowniku,
...
\sumitem{25--27}{\textbf{Strata krzyżowoentropijna jest ujemnym logarytmem
...
\sumitem{30--31}{\textbf{Label smoothing to metoda największej wiarogodności
...
\sumitem{32--33}{Ważenie klas szacuje parametry \emph{innej populacji}, a
  dzielenie przez liczbę tokenów jest tym, co czyni sekwencje różnej długości
  porównywalnymi.}
\sumitem{34--36}{\textbf{Kara jest logarytmem rozkładu a priori.} Pomnóż
...
\sumitem{37--38}{Zatem $\lambda = 1/\tau^{2}$, dopasowane na gradientach,
...
\sumitem{40}{MAP jest punktem i nie umie powiedzieć, jak bardzo jest pewny.
  Rozkład a posteriori jako rozkład należy do Programu~\ref{prog:P28}.}
\sumitem{41--43}{\textbf{Score} to $\partial \ln p / \partial\theta$, a jego
