...
we wskaźnikach jest to $\sum_k X_{ik} W_{jk}$. \textbf{Transpozycja nigdy nie
musiała się zdarzyć.} Jest opisem tego, który wskaźnik spotyka który, i żadna
tablica nie musi być obracana, żeby go spełnić.
\end{fr}
...
\textbf{Wszystko na lewo od strzałki, czego nie ma na prawo, jest sumowane.} To
doprecyzowanie z poprzedniej ramki, zapisane jako składnia, a nie jako
konwencja \dash{} i po to właśnie jest ta strzałka.
\end{fr}
...
To suma z ramki 12, wpisana. \textbf{Nie jest to nowy pomysł, sztuczka
biblioteki ani udogodnienie wydajnościowe} \dash{} to sigma z pominiętą sigmą,
a kto umie przeczytać tę sumę, przeczyta i ten napis.
\end{fr}
...
\textbf{Im lepszy staje się model, tym bardziej raportowana liczba kłamie}, bo
nadwyżka jest podwojoną kowariancją, a kowariancja jest dokładnie tym, co
trening zwiększa. Błąd łagodny, dopóki debugujesz, i ostry, gdy wszystko już
działa, ma najgorszy możliwy kształt.
\end{fr}
...
% ============================================================
\begin{summarybox}
\sumitem{1--3}{\textbf{Oś jest pozycją w krotce indeksów, a nie kierunkiem w
...
\sumitem{4--5}{\textbf{Trzy rzeczy nazywają się wymiarem} i odpowiadają na
...
\sumitem{6--8}{\emph{Rząd} tablicy to liczba jej osi, czyli inne słowo niż to z
...
\sumitem{9--12}{\textbf{Wskaźnik, który pojawia się dwa razy, jest sumowany, a
...
\sumitem{13--15}{$S_{bhqk} = \sum_d Q_{bhqd}K_{bhkd}$ to wsadowy wielogłowicowy
...
\sumitem{16--18}{\textbf{Napis \code{einsum} to tamta suma z pominiętą sigmą.}
...
\sumitem{21--22}{\textbf{\enquote{Powtórzony znaczy sumowany} to reguła dla
  ...
  różnych przykładów.}
\sumitem{23--25}{\textbf{Rozgłaszanie ma dokładną regułę}: zestaw kształty od
...
\sumitem{25--29}{\textbf{$(n)$ przeciwko $(n,1)$ daje $(n,n)$}, więc strata
...
\sumitem{30--32}{\code{keepdims} zostawia oś długości $1$ na miejscu, żeby
...
\sumitem{33--36}{\textbf{Ten sam kształt to nie ta sama tablica.}
