...
\outcome{32--37}{say what forty comparisons on one leaderboard do to all of
  the above}
\outcome{38--40}{apply the whole of it to a number somebody has published}
\end{outcomes}
...
\sumitem{38--40}{\result{What is left when a comparison cannot resolve what you care
