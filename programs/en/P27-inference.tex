...
\sumitem{15--17}{\result{\textbf{Pairing multiplies the items you need by
  ...
  $\Var(X-Y)$}.}
\sumitem{18--19}{\result{\textbf{Only the discordant items carry the difference.}
...
\sumitem{19--20}{\result{Under \enquote{equally good} those items are fair coin
...
\sumitem{23--25}{\result{\textbf{A p-value is
  ...
  as the base rate}.}
\sumitem{26--27}{\result{Given a prior it can be turned round, and the answer is
...
\sumitem{28--29}{\result{\textbf{One comparison in twenty between identical models
  ...
  on it}.}
\sumitem{31--33}{\result{\textbf{$\val{p27.models}$ comparisons make that
...
\sumitem{34--35}{\result{\textbf{And sorting a table biases its top row.} The winner
...
\sumitem{37--39}{\result{What is left when a comparison cannot resolve what you care
