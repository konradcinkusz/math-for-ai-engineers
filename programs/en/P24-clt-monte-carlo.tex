%% P24 \dash{} Sums of random variables: the central limit theorem, concentration and Monte Carlo
%%
...
four times as many \dash{} the fact that prices every evaluation run in the
book.
