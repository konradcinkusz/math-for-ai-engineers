...
\sumitem{31--33}{\result{\textbf{Rescaling a parameter changes the curvature by
...
\sumitem{37--38}{\result{\textbf{The step-size bound has the same problem and does not
