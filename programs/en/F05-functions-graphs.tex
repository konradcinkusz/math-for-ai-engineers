...
\index{graph (of a function)!transformations of}
...
\label{sec:F05-graph}
\index{graph (of a function)!reading values off}
...
is $\relu(x) = \max(0, x)$\index{ReLU}: it passes a positive number through
untouched and returns zero for anything negative.
...
\label{sec:F05-moves}
\index{graph (of a function)!shifting}
\index{graph (of a function)!stretching}
\index{graph (of a function)!reflecting}
