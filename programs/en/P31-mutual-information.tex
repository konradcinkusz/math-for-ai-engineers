...
\sumitem{3--4}{\textbf{\result{Mutual information is a divergence}}:
...
\sumitem{26--27}{\textbf{\result{Post-processing cannot create information}}: if
...
\sumitem{35--38}{\textbf{\result{Nothing here was measured on a real model}}, and the
