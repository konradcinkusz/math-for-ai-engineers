%% P20 \dash{} Stochastic optimisation and differentiating through randomness
%%
...
sampling step \dash{} the score-function estimator (REINFORCE, unbiased and high
variance) and the reparameterisation trick (low variance, requires a
differentiable path) \dash{} which is the fork that separates policy-gradient
RLHF from a VAE.
