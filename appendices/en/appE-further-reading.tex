...
%
% STILL OUTSTANDING: nothing in the book references this appendix. There is no
% \ref{app:E} anywhere in programs/, so a reader standing at a rigour box has
% no way to know section E.5 exists. Closing it means editing every deferring
% program and is a pass of its own.
%
