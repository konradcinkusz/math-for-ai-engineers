...
\plterm{significand}{mantysa}{The English edition writes \emph{significand} and
  the Polish \emph{mantysa}; each is in real use in its own language.
  Program~\ref{prog:P01} carries a notation box on it.}
