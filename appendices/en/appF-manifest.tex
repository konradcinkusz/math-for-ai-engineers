...
experiment table gives: a list can be read and a tally decays, and this one
...
a debt against whether anybody can obtain the book at all. The number is issued rather
than derived, which is why the copyright page names its absence rather than
