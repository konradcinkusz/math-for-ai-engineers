...
at roughly three quarters through the early Foundation programs and between
a third and two in five across Part~III, and the book's own figure is
$\val{appf.elicit.pct}$ per cent. That is a real unevenness in the teaching
rather than a statistic: a program that tells you more than it asks you is a
program you will retain less from, whatever it says about itself.
