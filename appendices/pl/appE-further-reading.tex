...
\medskip
I jedno wyłączenie, które nie należy do żadnej z tych trzech tabel, a warto
powiedzieć to wprost, zamiast wpisywać je pod najbliższy nagłówek.
\textbf{Specyfikacja formalna} \dash{} systemy przejść, niezmienniki
indukcyjne, logika temporalna, refinement \dash{} nie jest rygorystycznym
fundamentem pod tym, czego ta książka uczy, bo nie leży tu pod niczym. Nie
jest specjalizacją zaczynającą się tam, gdzie kończy się głębokość robocza, bo
nie ma tu głębokości roboczej, od której mogłaby się zacząć. I nie jest
techniką, którą wyręcza dziś biblioteka, bo tym, co produkuje, jest zdanie, a
nie obliczenie.

Książka daje grunt, na którym to stoi, i na tym się zatrzymuje.
Program~\ref{prog:F10} daje zbiór, a Program~\ref{prog:P13} zbudowaną na nim
relację; Program~\ref{prog:P14} uczy \emph{czytać} twierdzenie i świadomie
nie uczy go pisać \dash{} a niezmiennik indukcyjny trzeba napisać. Po samą
notację: Wayne, potem Lamport; Jackson po te same rzeczy na relacjach, a Leino
po wersję mieszkającą w źródle samego programu.

\medskip
\textbf{I wyłączenia, co do których ta książka jest najmniej pewna},
...
\emph{Specyfikacja formalna} jest wyłączona, a wątpić w to każe kształt roboty
czytelnika, a nie kształt matematyki. Argumentem za pominięciem było to, że
matematyka inżyniera jest matematyką modelu. Argumentem przeciw jest to, że
kiedy kod przychodzi napisany przez coś innego, zostaje powiedzieć, co znaczy
poprawnie, a potem to sprawdzić \dash{} a pierwsze z tych dwóch jest notacją,
której ta książka nie uczy. Program~\ref{prog:P25} wyznacza miejsce, w którym
kończy się połowa statystyczna: przebieg zielonych ogranicza odsetek po
wejściach, z których losował, i nie mówi nic o żadnym z nich z osobna, a
powiedzenie czegoś o którymkolwiek z nich jest tym, do czego służy
niezmiennik.
...
Nierówność koncentracyjna i dlaczego ograniczoność wystarcza &
  \ref{prog:P25} & Wasserman \\
\bottomrule
\end{tabularx}
\end{center}
