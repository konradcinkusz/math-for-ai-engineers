...
%
% SEKCJA E.6 JEST LISTĄ, A NIE TABELĄ, celowo, i nie wolno jej w tabelę
% przerobić. Blok center+tabularx nie łamie się przez stronę, a ten dodatek
% wyprodukował już z tego największy overfull vbox w książce -- 284 pt, z
% tabeli wykluczeń w sekcji E.3. Decyduje liczba wierszy razy ich wysokość, a
% cytowanie to trzy złożone linie tam, gdzie wiersze E.5 mają jedną, więc
% sześć z nich daje mniej więcej tę wysokość, która się przelała. reslist to
% itemize, więc się łamie; klasa znika, a nie staje się mniej prawdopodobna,
% na obu instalacjach i przy każdym położeniu na stronie.
%
% To jest książkowa lista materiału źródłowego \dash{} Dodatek C odtwarza
% przez nią każdy \result{} \dash{} a uzasadnienie jej wyrównania do lewej,
% napisane w preambule obok niej, dotyczy materiału źródłowego w ogóle. Użycie
% jej tutaj wiąże tę sekcję z tamtą: zmiana stylu reslist dla Dodatku C zmieni
% też to, o czym warto wiedzieć, zanim ktoś to zrobi.
%
...
\item K. A. Stroud, \emph{Engineering Mathematics: Programmes and Problems},
  Macmillan, 1970 \dash{} sam format.
\item C. C. Kulik, B. J. Schwalb i J. A. Kulik, \enquote{Programmed
  Instruction in Secondary Education: A Meta-Analysis of Evaluation Findings},
  \emph{Journal of Educational Research}, 75, 133--138, 1982 \dash{} argument
  przeciw niemu.
\item H. L. Roediger i J. D. Karpicke, \enquote{Test-Enhanced Learning:
  Taking Memory Tests Improves Long-Term Retention}, \emph{Psychological
  Science}, 17, 249--255, 2006 \dash{} przypominanie z pamięci i odstępy, po
  których przewaga się pojawia.
\item N. Kornell, M. J. Hays i R. A. Bjork, \enquote{Unsuccessful Retrieval
  ...
  generowanie błędu.
\item B. Butterfield i J. Metcalfe, \enquote{Errors Committed with High
  Confidence Are Hypercorrected}, \emph{Journal of Experimental Psychology:
  Learning, Memory, and Cognition}, 27, 1491--1494, 2001 \dash{} dlaczego
  korzyść jest największa, gdy uczący się był pewny swego.
\item J. D. Karpicke, A. C. Butler i H. L. Roediger, \enquote{Metacognitive
  Strategies in Student Learning: Do Students Practise Retrieval When They
  Study on Their Own?}, \emph{Memory}, 17, 471--479, 2009 \dash{} dlaczego
  metoda, która uczy więcej, wydaje się gorsza.
\end{reslist}
...
\begin{reslist}
\item C. Eckart i G. Young, \enquote{The Approximation of One Matrix by
...
\item D. P. Kingma i J. Ba, \enquote{Adam: A Method for Stochastic
  Optimization}, \emph{International Conference on Learning Representations},
  2015 \dash{} Program~\ref{prog:F02}.
\item J. L. Ba, J. R. Kiros i G. E. Hinton, \enquote{Layer Normalization},
...
\item A. Vaswani et al., \enquote{Attention Is All You Need}, \emph{Advances
  ...
  Programy~\ref{prog:F02} i~\ref{prog:F08}.
\item K. He, X. Zhang, S. Ren i J. Sun, \enquote{Delving Deep into
