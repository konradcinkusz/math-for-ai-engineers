...
Specyfikacji formalnej: systemów przejść, niezmienników indukcyjnych, logiki
  temporalnej & Program~\ref{prog:P14} uczy \emph{czytać} twierdzenie i
  świadomie nie uczy go pisać, a niezmiennik indukcyjny trzeba napisać;
  Programy~\ref{prog:F10} i~\ref{prog:P13} dają zbiór i relację, a nic tutaj
  nie idzie dalej, do maszyny stanów & Lamport; Jackson \\
\bottomrule
\end{tabularx}
\end{center}
...
niezmiennik. Wayne to praktyczne wejście, a Lamport stojące za nim źródło;
Jackson robi te same rzeczy na relacjach, a Leino w wersji mieszkającej w
źródle samego programu.
