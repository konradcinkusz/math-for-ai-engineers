...
\fancyhead[RO]{\small\lblFrame~\theframeno}
...
\renewcommand{\chaptermark}[1]{\markboth{\lblProgram\ \thechapter.\ #1}{}}
...
\newcommand{\blank}[1][4em]{\makebox[#1]{\dotfill}}
...
% The frames that teach the question just asked.
...
\newcommand{\val}[1]{%
  \ifcsdef{mfaval@#1}{\mfanum{\csuse{mfaval@#1}}}%
...
\newcommand{\mermaidfig}[3]{%
  ...
  \IfFileExists{figures/diagrams/\booklang/#1.pdf}{%
    ...
    \begin{tcolorbox}[
      enhanced, breakable, width=0.98\linewidth, sharp corners,
